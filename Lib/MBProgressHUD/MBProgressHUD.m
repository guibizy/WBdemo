...
//    CGSize labelSize = MB_TEXTSIZE(label.text, label.font);
    CGFloat remainingHeight1 = bounds.size.height - totalSize.height - kPadding - 4 * margin;
    CGSize maxSize1 = CGSizeMake(maxWidth, remainingHeight1);
    CGSize labelSize = MB_MULTILINE_TEXTSIZE(label.text, label.font, maxSize1, label.lineBreakMode);
